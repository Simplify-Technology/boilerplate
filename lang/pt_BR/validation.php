...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Convenção "atributo.regra". Mensagem específica de um Form Request
    | continua no `messages()` dele — aqui só entra o que vale para o
    | sistema inteiro.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Substitui o placeholder `:attribute` por algo legível — sem isto o
    | usuário lê "O campo password_confirmation é obrigatório". Apenas
    | campos genéricos do boilerplate; adicione os do seu domínio.
    |
    */
